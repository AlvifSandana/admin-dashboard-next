                ...
                <div className="row">
                  <div className="col-sm-6">
                    ...
                    <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="assets/modules/flag-icon-css/flags/4x3/id.svg" alt="image" width={40} />
                      ...
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="assets/modules/flag-icon-css/flags/4x3/my.svg" alt="image" width={40} />
                        <div className="media-body ml-3">
                      ...
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="assets/modules/flag-icon-css/flags/4x3/us.svg" alt="image" width={40} />
                        <div className="media-body ml-3">
                  ...
                  <div className="col-sm-6 mt-sm-0 mt-4">
                    ...
                    <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                      ...
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="assets/modules/flag-icon-css/flags/4x3/ps.svg" alt="image" width={40} />
                        <div className="media-body ml-3">
                      ...
                      <li className="media">
                        <img className="img-fluid mt-1 img-shadow" src="assets/modules/flag-icon-css/flags/4x3/de.svg" alt="image" width={40} />
                        <div className="media-body ml-3">
